        ...
        <div class="panel panel-default">
        	<div class="panel-heading">
				...
				<div class="row">
				  ...
				  <div class="col-sm-3">
				    <a class="btn-clean pull-right" href="#">
        	...
        	<div class="panel-body">
               <ul class="nav nav-tabs">
                 <li class="active"><a data-toggle="tab" href="#ActiveCourse">Active Courses</a></li>
                 <li><a data-toggle="tab" href="#inActive">InActive Courses</a></li>
               </ul>

              <div class="tab-content">
			   
                 <div id="ActiveCourse" class="tab-pane fade in active">
				 <div class="row">
				   <div class="col-sm-3 col-sm-offset-3">
				    <div class="margin">
                   <div class="button-group clean">
                     <a class="btn-clean button-dropdown" href="#" data-toggle="dropdown">
                        All Categories <i class="ion-ios-arrow-down"></i>
                     </a>
                   ...
                   <div class="button-group clean">
                     <a class="btn-clean button-dropdown" href="#" data-toggle="dropdown">
                        All Instructer <i class="ion-ios-arrow-down"></i>
                     </a>

                    <ul class="dropdown-menu clean">
                      <li><a href="#">Alok Dubey</a></li>
                      <li><a href="#">Ravi R.Chokkalingam</a></li>
                      <li><a href="#">Praveen Dixit</a></li>
                      <li><a href="#">Dr.Ravi Arghari</a></li>
                    </ul>
                    </div>
                   </div>
				   </div>
				 ...
				 <!--end admin dropdwon-->
				  <div class="row">
				    <div class="col-sm-3  admin_pic">
					  <img src="images/admin_pic1.png" width="160" height="125" class="thumbnail"/>
					</div>
				    <div class="col-sm-9 admin_tabContent">
					  <h3><a href="#">General Science & Tech, Environment & Ecology</a></h3>
					  <p>
					   <span class="admin_content_credit"><i class="fa fa-credit-card" aria-hidden="true"></i> &nbsp;<b>₹ 80,000</b></span>
					   <span class="admin_content_credit"><i class="fa fa-clock-o" aria-hidden="true"></i> &nbsp;<b>2 Hours</b></span>
					   <span class="admin_content_time"><i class="fa fa-calendar" aria-hidden="true"></i> &nbsp;<b>2017-03-22 12:00</b></span>
					   <span class="pull-right admin_editBtn"><a href="#">Edit</a></span>
					  </p>
					  <p class="admin_para">
					  This is an Online version of offline classroom Program designed to cover General Science & Environment for Prelims 2017 and Mains 2017.
					  </p>
					</div>
				  </div>
				  <!--first containerend-->
		...
		<nav class="navbar navbar-default" role="navigation">
			...
			<div class="side-menu-container">
				<ul class="nav navbar-nav">
					<li class="active"><a href="#"><span class="glyphicon glyphicon-dashboard"></span> Courses</a></li>
					<li><a href="#"><span class="glyphicon glyphicon-dashboard"></span></span> Categories</a></li>
					<li><a href="#"><span class="glyphicon glyphicon-dashboard"></span></span> All Units</a></li>
					<li><a href="#"><span class="glyphicon glyphicon-dashboard"></span></span> Callback Request</a></li>
					<li><a href="#"><span class="glyphicon glyphicon-dashboard"></span></span> Course Review</a></li>
