    ...
    <div class="col-md-9 content">
        <div class="panel panel-default">
        	<div class="panel-heading">
        		<h2 class="lms">LMS<small> Units</small></h2>
				<div class="row">
        	...
        	<div class="panel-body">
              ...
              <div class="tab-content">
                 ...
                 <div id="category_ActiveCourse" class="tab-pane fade in active">
				  ...
				  <div class="row">
				    <div class="col-sm-12">
					  <h3 class="admin_Unit_title">Budget Basics and Budget Making Process</h3>
					  <span class="unit_editBtn pull-right">
					   <a href="#">Edit</a>
					  </span>
					  <span class="unit_video">
					  Video
					  </span>
					</div>
				  </div>
				 ...
				 <div class="row">
				    <div class="col-sm-12">
					  <h3 class="admin_Unit_title">Budget Types & Classifications</h3>
					  <span class="unit_editBtn pull-right">
					   <a href="#">Edit</a>
					  </span>
					  <span class="unit_video">
				  ...
				  <div class="row">
				    <div class="col-sm-12">
					  <h3 class="admin_Unit_title">GSM – Foundation – Polity 01</h3>
					  <span class="unit_editBtn pull-right">
					   <a href="#">Edit</a>
					  </span>
					  <span class="unit_video">
				  ...
				  <div class="row">
				    <div class="col-sm-12">
					  <h3 class="admin_Unit_title">GSM – Foundation – Polity 03</h3>
					  <span class="unit_editBtn pull-right">
					   <a href="#">Edit</a>
					  </span>
					  <span class="unit_video">
