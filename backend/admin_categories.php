    ...
    <div class="col-md-9 content">
        <div class="panel panel-default">
        	<div class="panel-heading">
        		<h2 class="lms">LMS<small> Course Category</small></h2>
				<div class="row">
                 ...
                 <div id="category_ActiveCourse" class="tab-pane fade in active">
				  <div class="row">
				    <div class="col-sm-3  admin_pic">
					  <img src="images/admin_pic1.png" width="160" height="125" class="thumbnail text-center"/>
					</div>
				    <div class="col-sm-9 admin_catg_tabContent">
					 <span><a href="#" class="admin_catg_btn">Upcoming Course</a></span>
					 <p class="admin_cat_para">Ravi Chokkalingam is Delhi’s Top Faculty for Current Affairs & General Studies.
					 He has trained hundreds of students for Prelims , Mains and the Interview.</p>
 					</div>
				  </div>
                  <!--first ctaegory section end-->
				  <div class="row">
				    <div class="col-sm-3  admin_pic">
					  <img src="images/admin_pic1.png" width="160" height="125" class="thumbnail text-center"/>
					</div>
				    <div class="col-sm-9 admin_catg_tabContent">
					 <span><a href="#" class="admin_catg_btn">Prelims</a></span>
					 <p class="admin_cat_para">Prelims Description</p>
 					</div>
				  </div>
				   <!--second ctaegory section end-->
				   <div class="row">
				    <div class="col-sm-3  admin_pic">
					  <img src="images/admin_pic1.png" width="160" height="125" class="thumbnail text-center"/>
					</div>
				    <div class="col-sm-9 admin_catg_tabContent">
					 <span><a href="#" class="admin_catg_btn">Mains</a></span>
					 <p class="admin_cat_para">Optional</p>
 					</div>
				  </div>
				  <!--third ctaegory section end-->
				   <div class="row">
				    <div class="col-sm-3  admin_pic">
					  <img src="images/admin_pic1.png" width="160" height="125" class="thumbnail text-center"/>
					</div>
				    <div class="col-sm-9 admin_catg_tabContent">
					 <span><a href="#" class="admin_catg_btn">Optional</a></span>
					 <p class="admin_cat_para">	Optional Description</p>
 					</div>
				  </div>
				   <!--third ctaegory section end--> 
				   <div class="row">
				    ...
				    <div class="col-sm-9 admin_catg_tabContent">
					 <span><a href="#" class="admin_catg_btn">Interview</a></span>
					 <p class="admin_cat_para">Interview Description</p>
 					</div>
				  </div>
                 </div>
