...
<div class="conatiner-fluid dashboard_graph">
  <div class="row">
    <div class="col-sm-4">
	  <div class="row">
	    <div class="col-sm-12 left_graph1">
		 <img src="images/snapshot.jpg" class="img-responsive"/>
		</div>
	  </div>
	  <div class="row">
	    <div class="col-sm-12 transction_div">
		 <h2>Transactions <button type="button" class="btn pull-right">STATEMENT</button></h2>
		 <h4>Latest from statement</h4>
		 <div class="table-responsive">          
          <table class="table">
           <tbody>
           <tr>
            <td><strong>15 Jan 2015</strong></td>
            <td><strong>Adrian Demian</strong></td>
            <td><a href="#"><strong>#14173</strong></a></td>
            <td>$41</td>
           </tr>
           <tr>
            <td><strong>15 Jan 2015</strong></td>
		  ...
		  <p><button type="button" class="btn btn-default">View All</button></p>
		</div>
	  </div>
	</div>
	<div class="col-sm-6">
	  <div class="row">
	     <div class="col-sm-10 col-sm-offset-1 middle_graph1">
		     <h2 class="myCourse">My Courses</h2>
             <p class="current_course"><strong>Your current Course</strong></p>
             <p><strong><a href="#">Basic of HTML</strong></a> <span class="pull-right"><a href="#"><i class="fa fa-eye" aria-hidden="true"></i> View</a></span></p>
             <p><strong><a href="#">Basic of Javacsript</strong></a> <span class="pull-right"><a href="#"><i class="fa fa-eye" aria-hidden="true"></i> View</a></span></p>
             <p><strong><a href="#">Basic of Angular</strong></a> <span class="pull-right"><a href="#"><i class="fa fa-eye" aria-hidden="true"></i> View</a></span></p>
             <p><strong><a href="#">Basic of CSS</strong></a> <span class="pull-right"><a href="#"><i class="fa fa-eye" aria-hidden="true"></i> View</a></span></p>
             <p><strong><a href="#">Basic of HTML</strong></a> <span class="pull-right"><a href="#"><i class="fa fa-eye" aria-hidden="true"></i> View</a></span></p>
             <p><button type="button" class="btn btn-primary"><strong>CREATE COURSES <i class="fa fa-plus" aria-hidden="true"></i></strong></button> 
			 <span class="pull=right"><button type="button" class="btn btn-default"><strong>VIEW ALL</strong></button></span></P>			 
		 </div>
	  </div>
	  <div class="row">
	     <div class="col-sm-10 col-sm-offset-1 middle_graph2">
		     <h2 class="myCourse">Comments</h2>
             <p class="current_course"><strong>Your recent Course</strong></p>
             <div class="row">
			   <div class="col-sm-2">
			    <img src="images/comment_thumb.jpg" class="img-responsive"/>
			   </div>
			   <div class="col-sm-10">
			    <p><a href="3"><b>mosaicpro</b></a> <small>3 min ago</small> <span class="pull-right"><a href="#"><i class="fa fa-external-link" aria-hidden="true"></i></a></span></p>
				<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusantium alias, blanditiis eligendi expedita ipsam minus non
				numquam quidem reiciendis ut?</p>
			   </div>
			 </div>			 
		 </div>
		 <div class="col-sm-10 col-sm-offset-1 cmnt2">
             <div class="row">
			   <div class="col-sm-2">
			    <img src="images/comment_thumb.jpg" class="img-responsive"/>
			   </div>
